SELECT drp.period_id, drp.time_id,
      ...
      LEFT JOIN (SELECT drp1.period_id, drp1.time_id,
                   ...
                   JOIN fact_events engagements
                    ...
                    AND engagements.occurred_at >= TO_TIMESTAMP( '2012-06-01', 'YYYY-MM-DD HH24:MI:SS' )
                    AND engagements.occurred_at <= TO_TIMESTAMP( '2012-06-02', 'YYYY-MM-DD HH24:MI:SS' )
                  ...
                  WHERE drp1.period_id = 2001
                    AND drp1.time_id >= TO_TIMESTAMP( '2012-06-01', 'YYYY-MM-DD HH24:MI:SS' )
                    AND drp1.time_id <= TO_TIMESTAMP( '2012-06-02', 'YYYY-MM-DD HH24:MI:SS' )
      ...
      LEFT JOIN (SELECT drp2.period_id, drp2.time_id,
                   ...
                   JOIN dimension_messages m
                    ...
                    AND m.created_at >= TO_TIMESTAMP( '2012-06-01', 'YYYY-MM-DD HH24:MI:SS' )
                    AND m.created_at <= TO_TIMESTAMP( '2012-06-02', 'YYYY-MM-DD HH24:MI:SS' )
                  WHERE drp2.period_id = 2001
                    AND drp2.time_id >= TO_TIMESTAMP( '2012-06-01', 'YYYY-MM-DD HH24:MI:SS' )
                    AND drp2.time_id <= TO_TIMESTAMP( '2012-06-02', 'YYYY-MM-DD HH24:MI:SS' )
                  GROUP BY drp2.period_id, drp2.time_id) m1
        ON m1.time_id = drp.time_id
     WHERE drp.period_id = 2001
       AND drp.time_id >= TO_TIMESTAMP( '2012-06-01', 'YYYY-MM-DD HH24:MI:SS' )
       AND drp.time_id <= TO_TIMESTAMP( '2012-06-02', 'YYYY-MM-DD HH24:MI:SS' )
;
